  ...
  const editors = createElement(
    ...
    createElement(
      ...
      createElement(
        ...
        ' 为环境变量. Windows 上反斜杠是分隔符而不是转义符, ',
        createElement('code', null, 'C:\\Users\\me\\caches'), ' 原样生效, ',
        createElement('code', null, '~\\caches'), ' 也算家目录, 盘符相对路径 ',
        createElement('code', null, 'C:caches'), ' 没有固定落点, 会被拒绝. 绝对路径按文件系统解析 (',
