...
*/
const DEFAULT_WATCH_TTL_MIN_MS = 2e3;
/**
* 自适应刷新时长的上界: 上次展开耗时乘倍率后不高于它, 保证 watcher 漏事件时
* 结果也不会长时间陈旧.
*/
const DEFAULT_WATCH_TTL_MAX_MS = 3e4;
/**
...
//#endregion
export { DEFAULT_WATCH_TTL_MIN_MS as a, PREVIEW_PATH as c, DEFAULT_WATCH_TTL_MAX_MS as i, REQUEST_WRITABLE_PATH_TOOL as l, DEFAULT_READONLY_FILE_NAME as n, DEFAULT_WRITABLE_PATHS as o, DEFAULT_READ_ONLY_PATHS as r, GRANTS_PATH as s, isPathUnder as t, isValidReadonlyFileName as u };

//# sourceMappingURL=containment-CwZXGzMh.mjs.map