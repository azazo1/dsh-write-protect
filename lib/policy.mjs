import { a as lastMatchKeeps, c as toPosix, d as DEFAULT_WRITABLE_PATHS, f as PREVIEW_PATH, i as isLiteralSegment, l as DEFAULT_READONLY_FILE_NAME, m as isValidReadonlyFileName, n as compileEntry, o as parsePatternLines, p as REQUEST_WRITABLE_PATH_TOOL, r as compileGitignore, s as stripTrailingSpaces, t as isPathUnder, u as DEFAULT_READ_ONLY_PATHS } from "./containment-BZPfOinD.mjs";
...
var WriteProtectPolicyService = class extends SandboxPolicyService {
	...
	*/
	...
	/** 展开缓存的键: 两份文本与工作区根都参与. */
	cacheKey(readOnlyText, writableText, workspaceRoot) {
		return [
			readOnlyText,
			writableText,
			workspaceRoot
	...
	async expandNow(workspaceRoot, key, readOnlyText, writableText) {
